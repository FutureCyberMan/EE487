...
net = jetson.inference.detectNet("multiped-500", threshold=0.9)
...
try:
	while True:
		...
		for detection in detections:
			...
			if (net.GetClassDesc(detection.ClassID)) == "person" and detection.Area > 72000 and detection.Area < 90000:
				go = False
				mtr_cmd[1] = -.5
				mtr_cmd[0] = .075
				myCar.write_mtrs(mtr_cmd)
